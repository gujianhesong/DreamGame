...
public class Player {
    ...
    // Terrain types that are impassable
    ...
    public void update(int[][] map, int mapWidth, int mapHeight, int tileSize) {
        ...
        int previousDirection = facingDirection;
        ...
        // Check terrain collision (can't walk on water or lava)
    ...
    public void draw(Canvas canvas, int offsetX, int offsetY) {
        ...
        // Animation offsets - different for walking vs idle
        ...
        canvas.drawCircle(centerX, centerY - 5 * scale + bobOffset * 0.5f, size * 0.65f * breathScale, paint);

        switch (facingDirection) {
            case 0: // Facing DOWN
                drawFacingDown(canvas, paint, centerX, centerY, scale, bobOffset, legOffset, armSwing, breathScale, isMoving);
                break;
            case 1: // Facing UP
                drawFacingUp(canvas, paint, centerX, centerY, scale, bobOffset, legOffset, armSwing, breathScale, isMoving);
                break;
            case 2: // Facing LEFT
                drawFacingLeft(canvas, paint, centerX, centerY, scale, bobOffset, legOffset, armSwing, breathScale, isMoving);
                break;
            case 3: // Facing RIGHT
                drawFacingRight(canvas, paint, centerX, centerY, scale, bobOffset, legOffset, armSwing, breathScale, isMoving);
                break;
        }

        // Floating energy particles (always animated)
        drawEnergyParticles(canvas, paint, centerX, centerY, scale, isMoving);
    }
    ...
    private void drawEnergyParticles(Canvas canvas, Paint paint, float cx, float cy, float scale, boolean isMoving) {
        ...
        float particleSpeed = isMoving ? 6 : 3;
